...
public class Multilabel_Medical extends Dataset{

	private int[] rA;
	
	public Multilabel_Medical(){
		rA = new int[45];
	...
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/medical/medical-train.arff", getRestrictedAttributeIds());
	}

	@Override
	public RDTInstances getTestInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/medical/medical-test.arff", getRestrictedAttributeIds());
	}

	@Override
	public RDTInstances getCVInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/medical/medical.arff", getRestrictedAttributeIds());
	}	
	...
	public DatasetType getDatasetType() {
		return DatasetType.MULTILABEL_MEDICAL;
	}
