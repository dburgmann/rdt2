...
public class Classification_Segment extends Dataset{

	@Override
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/classification/segment.arff", getRestrictedAttributeIds());
	}
	...
	public DatasetType getDatasetType() {
		return DatasetType.CLASSIFICATION_SEGMENT;
	}
