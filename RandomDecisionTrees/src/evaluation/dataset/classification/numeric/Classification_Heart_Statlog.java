...
public class Classification_Heart_Statlog extends Dataset{

	@Override
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/classification/heart-statlog.arff", getRestrictedAttributeIds());
	}
	...
	public DatasetType getDatasetType() {
		return DatasetType.CLASSIFICATION_HEART_STATLOG;
	}

	@Override
	public String getName() {
		return "heart-statlog";
	}
}
