...
public class Classification_SolarM extends Dataset{

	@Override
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/classification/solar-flare-m.arff", getRestrictedAttributeIds());
	}
	...
	public DatasetType getDatasetType() {
		return DatasetType.CLASSIFICATION_SOLAR_M;
	}

	@Override
	public String getName() {
		return "solar-flare-m";
	}
}
