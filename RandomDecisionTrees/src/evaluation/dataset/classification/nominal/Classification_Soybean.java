...
public class Classification_Soybean extends Dataset{

	@Override
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/classification/soybean.arff", getRestrictedAttributeIds());
	}
	...
	public DatasetType getDatasetType() {
		return DatasetType.CLASSIFICATION_SOYBEAN;
	}
