...
public class Classification_Spectrometer2 extends Dataset{

	@Override
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/classification/spectrometer2.arff", getRestrictedAttributeIds());
	}
	...
	public DatasetType getDatasetType() {
		return DatasetType.CLASSIFICATION_SPECTROMETER;
	}

	@Override
	public String getName() {
		return "spectrometer2";
	}
}
