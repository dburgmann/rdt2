...
public class Multilabel_Mediamill extends Dataset{

	private int[] rA;
	
	public Multilabel_Mediamill(){
		rA = new int[101];
	...
	public RDTInstances getTrainInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/mediamill/mediamill-train.arff", getRestrictedAttributeIds());
	}

	@Override
	public RDTInstances getTestInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/mediamill/mediamill-test.arff", getRestrictedAttributeIds());
	}

	@Override
	public RDTInstances getCVInstances() throws IOException, RDTException {
		return new RDTInstances("data/multilabel/mediamill/mediamill.arff", getRestrictedAttributeIds());
	}	
	...
	public DatasetType getDatasetType() {
		return DatasetType.MULTILABEL_MEDIAMILL;
	}
